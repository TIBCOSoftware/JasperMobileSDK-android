...
public class ResourceWebViewClient extends WebViewClient {
    private final static WebClientEventCallback EMPTY = new WebClientEventCallback() {
        ...
        @Override
        public void onSslCertificateError(SslErrorHandler handler, SslError error) {
    ...
    public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
        webClientEventCallback.onSslCertificateError(handler, error);
    }
    ...
    public interface WebClientEventCallback {
        ...
        void onSslCertificateError(SslErrorHandler handler, SslError error);
    }
